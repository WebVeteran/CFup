function showfile(thisfile, path, ffile, doctype) {
	...
	document.getElementById(ffile).innerHTML = "<img src='js/fancy_upload/icons/"+myfileext+"' height='16' width='16'> "+myFilename+"";
}
...
function resetfield(thisfile, path, ffile, doctype) {
		...
		document.getElementById(ffile).innerHTML = "<img src='js/fancy_upload/icons/null.gif' height='16' width='16'>No file selected";		
}