...
<cfif FUloadbase is 1>
	<script type="text/javascript" src="js/fancy_upload/fancyupload.js"></script>
	<style type="text/css">
		.filefield {
...
<cfoutput>
<div style="width:#FUwidth#; height:#FUheight#; display:inline-table; margin-left:-27px">
<div style="white-space:nowrap; position:absolute;">
	<input type="text" size="1" style="visibility:hidden;" id="mover" name="mover"><input type="button" value="Pick File" style="width:width:60px;" id="browseLabel"><cfif FUlabelposition is 'right'> <span id="#FUinputname#attach"><img src="js/fancy_upload/icons/null.gif" height="16" width="16">No file selected</span></cfif></div>
...
<cfif FUlabelposition is 'bottom'><span id="#FUinputname#attach"><img src="js/fancy_upload/icons/null.gif" height="16" width="16">No file selected</span></cfif>
</cfoutput>
